						...
						<div class="card">
							<div class="card-header">
								...
								<button class="btn btn-success mb-3"
									onclick="openAddBrandPopup()">Add New Brand</button>
							</div>
							<div class="card-body">
												...
												<tr>
													...
													<td>
														<button class="btn btn-primary"
															onclick="editBrand(${brand.id}, '${brand.name}')">Edit</button>
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					<form id="addBrandForm"
						action="${pageContext.request.contextPath}/admin/brands/add.htm"
						method="post">
						<div class="form-group">
							<label for="brandName">Brand Name</label> <input type="text"
								class="form-control" id="brandName" name="brandName" required>
						</div>
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					<form id="editBrandForm" action="" method="post">
						...
						<div class="form-group">
							<label for="editBrandName">Brand Name</label> <input type="text"
								class="form-control" id="editBrandName" name="brandName"
								required>
						</div>
						<button type="submit" class="btn btn-primary">Save</button>
					</form>
